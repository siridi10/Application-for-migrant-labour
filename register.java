...
public class register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this, R.id.na1, RegexTemplate.NOT_EMPTY, R.string.invalid_name);
        awesomeValidation.addValidation(this, R.id.p1, "[5-9]{1}[0-9]{9}$", R.string.invalid_mobile);
        ...
        bt_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (awesomeValidation.validate()) {
                    ...
                    Toast.makeText(register.this, "validation failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
